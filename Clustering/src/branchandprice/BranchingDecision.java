...
public class BranchingDecision
{
    ...
    public BranchingDecision(Point point, int pointIndex, int dimension, double threshold, boolean max, boolean lowerBound)
    {
    	_point = point;
...
//    	System.out.println("Compat " + cluster + " BC: " + this + " = " + ret);
	...
	public boolean equals(Object obj)
	{
		...
		if (getClass() != obj.getClass())
			return false;
		BranchingDecision other = (BranchingDecision) obj;
